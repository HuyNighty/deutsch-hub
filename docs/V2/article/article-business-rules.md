...
- The first Draft Version is created.
- The Draft Version contains the initial Article Title.
- The Draft Version is ready for further editing.

## Input

- Title is required.
- Title must satisfy the `ArticleTitle` Value Object invariants.
---
