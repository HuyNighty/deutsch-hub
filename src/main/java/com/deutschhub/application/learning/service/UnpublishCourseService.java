...
import com.deutschhub.application.learning.port.in.UnpublishCourseUseCase;
...
public class UnpublishCourseService implements  UnpublishCourseUseCase {
    ...
    @Override
    public CourseResponse unpublishCourse(UUID courseId, UUID actorId, boolean admin) {
        Course course = courseRepositoryPort.findById(courseId)
                .orElseThrow(() -> new BusinessException(ErrorCode.COURSE_NOT_FOUND));

            course.unpublish(actorId, admin);
