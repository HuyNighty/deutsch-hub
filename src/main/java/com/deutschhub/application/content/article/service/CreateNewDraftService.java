...
public class CreateNewDraftService implements CreateNewDraftUseCase {
    ...
    private CreateNewDraftResponse toResponse(Article article) {
        return new CreateNewDraftResponse(article.getId(), article.getDraftVersionId(), article.getEditorialStatus(), article.getPublicationStatus());
    }
}
